...
### v2.1.0 (2026-08-07) - GUI 与零依赖版本

- 🖥️ 新增 PowerShell + WinForms 图形界面（`Windows_Cleaner_GUI.ps1`，零依赖）
- 🚀 新增 `启动清理工具.bat` 启动器，隐藏 PowerShell 窗口
- 🔒 开始清理前二次确认，危险项标红警示
- 🧹 去除破坏性操作代码（legacy 注释化 + GUI 移除系统关键删除项）
- 🐛 修复 GUI 窗口/按钮显示不全、横幅乱码等问题
